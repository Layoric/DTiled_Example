...
function dart_precompiled($collectedClasses) {
  ...
  function Camera(Position, Width, Height, Target, ClampRect, Zoom, Rotation, Momentum, Speed, ViewPort, WorldRect) {
  ...
  function MapDto(MapName, height, layers, orientation, properties, tileheight, tilesets, tilewidth, version, width) {
  ...
  MapDto.builtin$cls = "MapDto";
  if (!"name" in MapDto)
    MapDto.name = "MapDto";
  $desc = $collectedClasses.MapDto;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MapDto.prototype = $desc;
  function TileSetDto(firstgid, image, imageheight, imagewidth, margin, name, properties, spacing, tileheight, tileproperties, tilewidth, transparentcolor, tileoffset, guid, texture) {
  ...
  TileSetDto.builtin$cls = "TileSetDto";
  if (!"name" in TileSetDto)
    TileSetDto.name = "TileSetDto";
  $desc = $collectedClasses.TileSetDto;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TileSetDto.prototype = $desc;
  TileSetDto.prototype.get$name = function(receiver) {
    return this.name;
  };
  TileSetDto.prototype.get$guid = function() {
    return this.guid;
  };
  function LayerDto(data, objects, properties, height, name, opacity, type, visible, width, x, y, guid) {
    this.data = data;
  ...
  LayerDto.builtin$cls = "LayerDto";
  if (!"name" in LayerDto)
    LayerDto.name = "LayerDto";
  $desc = $collectedClasses.LayerDto;
  if ($desc instanceof Array)
    $desc = $desc[1];
  LayerDto.prototype = $desc;
  LayerDto.prototype.get$name = function(receiver) {
    return this.name;
  };
  LayerDto.prototype.get$opacity = function() {
    return this.opacity;
  };
  LayerDto.prototype.get$type = function(receiver) {
    return this.type;
  };
  LayerDto.prototype.get$visible = function() {
    return this.visible;
  };
  LayerDto.prototype.get$x = function(receiver) {
    return this.x;
  };
  LayerDto.prototype.get$y = function(receiver) {
    return this.y;
  };
  LayerDto.prototype.get$guid = function() {
    return this.guid;
  };
  function MapObjectDto(gid, height, name, properties, polygon, polyline, type, visible, width, x, y, rotation, guid) {
    this.gid = gid;
    this.height = height;
    this.name = name;
    this.properties = properties;
  ...
  MapObjectDto.builtin$cls = "MapObjectDto";
  if (!"name" in MapObjectDto)
    MapObjectDto.name = "MapObjectDto";
  $desc = $collectedClasses.MapObjectDto;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MapObjectDto.prototype = $desc;
  MapObjectDto.prototype.get$name = function(receiver) {
    return this.name;
  };
  MapObjectDto.prototype.get$type = function(receiver) {
    return this.type;
  };
  MapObjectDto.prototype.get$visible = function() {
    return this.visible;
  };
  MapObjectDto.prototype.get$x = function(receiver) {
    return this.x;
  };
  MapObjectDto.prototype.get$y = function(receiver) {
    return this.y;
  };
  MapObjectDto.prototype.get$rotation = function() {
    return this.rotation;
  };
  MapObjectDto.prototype.get$guid = function() {
    return this.guid;
  };
  function PolygonDto(x, y) {
    this.x = x;
    this.y = y;
  }
  PolygonDto.builtin$cls = "PolygonDto";
  if (!"name" in PolygonDto)
    PolygonDto.name = "PolygonDto";
  $desc = $collectedClasses.PolygonDto;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PolygonDto.prototype = $desc;
  PolygonDto.prototype.get$x = function(receiver) {
    return this.x;
  };
  PolygonDto.prototype.get$y = function(receiver) {
    return this.y;
  };
  function PolylineDto(x, y) {
    this.x = x;
    this.y = y;
  }
  PolylineDto.builtin$cls = "PolylineDto";
  if (!"name" in PolylineDto)
    PolylineDto.name = "PolylineDto";
  $desc = $collectedClasses.PolylineDto;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PolylineDto.prototype = $desc;
  PolylineDto.prototype.get$x = function(receiver) {
    return this.x;
  };
  PolylineDto.prototype.get$y = function(receiver) {
    return this.y;
  };
  function TileoffsetDto(x, y) {
    this.x = x;
    this.y = y;
  }
  TileoffsetDto.builtin$cls = "TileoffsetDto";
  if (!"name" in TileoffsetDto)
    TileoffsetDto.name = "TileoffsetDto";
  $desc = $collectedClasses.TileoffsetDto;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TileoffsetDto.prototype = $desc;
  TileoffsetDto.prototype.get$x = function(receiver) {
    return this.x;
  };
  TileoffsetDto.prototype.get$y = function(receiver) {
    return this.y;
  };
  function DTiledLoader(tilesetProvider, mapTiles) {
    this.tilesetProvider = tilesetProvider;
    this.mapTiles = mapTiles;
  }
  DTiledLoader.builtin$cls = "DTiledLoader";
  if (!"name" in DTiledLoader)
    DTiledLoader.name = "DTiledLoader";
  $desc = $collectedClasses.DTiledLoader;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DTiledLoader.prototype = $desc;
  function TiledMap(Height, Width, TileHeight, TileWidth, Orientation, Properties, Version, Tilesets, SourceTiles, TileLayers, ObjectLayers, GidToId, IdToGid) {
    this.Height = Height;
    this.Width = Width;
    this.TileHeight = TileHeight;
    this.TileWidth = TileWidth;
    ...
    this.GidToId = GidToId;
    this.IdToGid = IdToGid;
  }
  TiledMap.builtin$cls = "TiledMap";
  if (!"name" in TiledMap)
    TiledMap.name = "TiledMap";
  $desc = $collectedClasses.TiledMap;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TiledMap.prototype = $desc;
  function TiledLayer(Name, Opacity, Visible, Type, Properties, Tiles, Guid, MapObjects) {
    this.Name = Name;
    this.Opacity = Opacity;
    this.Visible = Visible;
    this.Type = Type;
  ...
  TiledLayer.builtin$cls = "TiledLayer";
  if (!"name" in TiledLayer)
    TiledLayer.name = "TiledLayer";
  $desc = $collectedClasses.TiledLayer;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TiledLayer.prototype = $desc;
  function TiledTileset(Name, TileWidth, TileHeight, Spacing, Margin, TileOffsetX, TileOffsetY, Properties, Tiles, ImageFileName, ImageWidth, ImageHeight, Texture) {
    this.Name = Name;
    this.TileWidth = TileWidth;
    this.TileHeight = TileHeight;
    this.Spacing = Spacing;
  ...
  TiledTileset.builtin$cls = "TiledTileset";
  if (!"name" in TiledTileset)
    TiledTileset.name = "TiledTileset";
  $desc = $collectedClasses.TiledTileset;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TiledTileset.prototype = $desc;
  function TiledTile(TilesetID, Properties, Source, Origin) {
    this.TilesetID = TilesetID;
    this.Properties = Properties;
    this.Source = Source;
    this.Origin = Origin;
  }
  TiledTile.builtin$cls = "TiledTile";
  if (!"name" in TiledTile)
    TiledTile.name = "TiledTile";
  $desc = $collectedClasses.TiledTile;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TiledTile.prototype = $desc;
  function TiledTileData(SourceID, Bounds, Rotation, MapPosition, WorldPosition) {
  ...
  TiledTileData.builtin$cls = "TiledTileData";
  if (!"name" in TiledTileData)
    TiledTileData.name = "TiledTileData";
  $desc = $collectedClasses.TiledTileData;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TiledTileData.prototype = $desc;
  TiledTileData.prototype.get$SourceID = function() {
    return this.SourceID;
  };
  function TiledMapObject(Name, Type, Bounds, Rotation, TileID, Visible, Properties, Guid) {
    this.Name = Name;
    this.Type = Type;
    this.Bounds = Bounds;
    this.Rotation = Rotation;
  ...
  TiledMapObject.builtin$cls = "TiledMapObject";
  if (!"name" in TiledMapObject)
    TiledMapObject.name = "TiledMapObject";
  $desc = $collectedClasses.TiledMapObject;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TiledMapObject.prototype = $desc;
  TiledMapObject.prototype.get$TileID = function() {
    return this.TileID;
  };
  function TiledIsometricRenderer(canvas, context, tilesetProvider, camera) {
    this.canvas = canvas;
    this.context = context;
    this.tilesetProvider = tilesetProvider;
    this.camera = camera;
  }
  TiledIsometricRenderer.builtin$cls = "TiledIsometricRenderer";
  if (!"name" in TiledIsometricRenderer)
    TiledIsometricRenderer.name = "TiledIsometricRenderer";
  $desc = $collectedClasses.TiledIsometricRenderer;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TiledIsometricRenderer.prototype = $desc;
  function TiledBaseRenderer() {
  }
  TiledBaseRenderer.builtin$cls = "TiledBaseRenderer";
  if (!"name" in TiledBaseRenderer)
    TiledBaseRenderer.name = "TiledBaseRenderer";
  $desc = $collectedClasses.TiledBaseRenderer;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TiledBaseRenderer.prototype = $desc;
  function LocalTilesetProvider(BaseAddress) {
    this.BaseAddress = BaseAddress;
  }
  LocalTilesetProvider.builtin$cls = "LocalTilesetProvider";
  if (!"name" in LocalTilesetProvider)
    LocalTilesetProvider.name = "LocalTilesetProvider";
  $desc = $collectedClasses.LocalTilesetProvider;
  if ($desc instanceof Array)
    $desc = $desc[1];
  LocalTilesetProvider.prototype = $desc;
  function TilesetProviderBase() {
  }
  TilesetProviderBase.builtin$cls = "TilesetProviderBase";
  if (!"name" in TilesetProviderBase)
    TilesetProviderBase.name = "TilesetProviderBase";
  $desc = $collectedClasses.TilesetProviderBase;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TilesetProviderBase.prototype = $desc;
  function InitialiseCanvas_closure() {
  }
  InitialiseCanvas_closure.builtin$cls = "InitialiseCanvas_closure";
  if (!"name" in InitialiseCanvas_closure)
    InitialiseCanvas_closure.name = "InitialiseCanvas_closure";
  $desc = $collectedClasses.InitialiseCanvas_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  InitialiseCanvas_closure.prototype = $desc;
  function InitialiseCanvas_closure0() {
  }
  InitialiseCanvas_closure0.builtin$cls = "InitialiseCanvas_closure0";
  if (!"name" in InitialiseCanvas_closure0)
    InitialiseCanvas_closure0.name = "InitialiseCanvas_closure0";
  $desc = $collectedClasses.InitialiseCanvas_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  InitialiseCanvas_closure0.prototype = $desc;
  function InitialiseCanvas_closure1() {
  }
  InitialiseCanvas_closure1.builtin$cls = "InitialiseCanvas_closure1";
  if (!"name" in InitialiseCanvas_closure1)
    InitialiseCanvas_closure1.name = "InitialiseCanvas_closure1";
  $desc = $collectedClasses.InitialiseCanvas_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  InitialiseCanvas_closure1.prototype = $desc;
  function InitialiseCanvas_closure2() {
  }
  InitialiseCanvas_closure2.builtin$cls = "InitialiseCanvas_closure2";
  if (!"name" in InitialiseCanvas_closure2)
    InitialiseCanvas_closure2.name = "InitialiseCanvas_closure2";
  $desc = $collectedClasses.InitialiseCanvas_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  InitialiseCanvas_closure2.prototype = $desc;
  function GetMap_closure() {
  }
  GetMap_closure.builtin$cls = "GetMap_closure";
  if (!"name" in GetMap_closure)
    GetMap_closure.name = "GetMap_closure";
  $desc = $collectedClasses.GetMap_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GetMap_closure.prototype = $desc;
  function GameLoop() {
  }
