...
String AuthorID;
String mapName;
String baseAddress = "/DTiled_Example/web/";
...
LocalTilesetProvider tileProvider;
Camera camera;
Rect renderRegion;
bool mapReady = false;
...
void InitialiseCanvas() {
  ...
  tileProvider = new LocalTilesetProvider(baseAddress);
  xTiledLoader = new DTiledLoader(tileProvider);
  GetMap();
}

void GetMap() {
        HttpRequest.request(baseAddress + mapName).then((r) {
